...
git clone --recurse-submodules https://github.com/infinityonlinesolutions/server-automation.git .
...
if [ -f "${SERVER_AUTOMATION_BASE_FOLDER}/README.md" ]; then
  ...
  echo "https://github.com/infinityonlinesolutions/server-automation"
  echo
fi
